...
Section mono_nat.
  ...
  Proof.
    ...
    by iCombine "H1 H2" gives %?%mono_nat_auth_dfrac_op_valid.
  Qed.
  ...
  Proof.
    ...
    by iCombine "Hauth Hlb" gives %?%mono_nat_both_dfrac_valid.
  Qed.
  ...
  Proof. unseal. intros. by iApply own_mono; apply mono_nat_lb_mono. Qed.
