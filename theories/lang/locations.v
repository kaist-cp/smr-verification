...
Definition loc_add (l : loc) (z : Z) : loc := (l.1, l.2 + z).

Notation "l +ₗ z" := (loc_add l%L z%Z)
  (at level 50, left associativity) : loc_scope.

Lemma loc_add_assoc l n n' : l +ₗ n +ₗ n' = l +ₗ (n + n').
Proof. rewrite /loc_add /=. f_equal. lia. Qed.
Lemma loc_add_0 l : l +ₗ 0 = l.
Proof. destruct l as [b o]. rewrite /loc_add /=. f_equal. lia. Qed.

Lemma loc_add_assoc_nat l (n n' : nat) : l +ₗ n +ₗ n' = l +ₗ (n + n')%nat.
Proof. rewrite /loc_add /=. f_equal. lia. Qed.
Lemma loc_add_0_nat l : l +ₗ 0%nat = l.
Proof. destruct l as [b o]. rewrite /loc_add /=. f_equal. lia. Qed.

Global Instance loc_add_inj l : Inj (=) (=) (loc_add l).
...
Notation "l  &ₜ  t" := (TLoc l t%Z : tagged_loc) (at level 12).
