...
properly. *)
Notation "# l" := (LitV l%Z%V%L%stdpp) (at level 8, format "# l").
...
Notation "'tag' e" := (UnOp LoadTagOp e%E) (at level 11) : expr_scope.
Notation "'untag' e" := (BinOp TagOp e%E (#0)%E) (at level 11) : expr_scope.
...
Notation "e1 `tag` e2" := (BinOp TagOp e1%E e2%E) (at level 12) : expr_scope.
